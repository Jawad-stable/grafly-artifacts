...
- **Editorial design pattern (2026 redesign)**: All major screens (auth, leaderboard, critique, lesson, home, onboarding, paywall) use a magazine-like editorial header: small uppercase eyebrow (13px Nunito_800ExtraBold mutedForeground letterSpacing 1.5) above a 38–44px Nunito_800ExtraBold headline (letterSpacing -1). Primary CTAs are near-black pills (bg=foreground, text=background, borderRadius=100, with Ionicons arrow-forward). Horizontal padding standardized to 24 across redesigned screens.
