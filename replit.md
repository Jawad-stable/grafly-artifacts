...
- **Core Screens & Components**:
    ...
    - **Mascot**: `GraflyMascot` component (`components/GraflyMascot.tsx`) with various states. Used in the Critique tab mentor-identity row to give the AI mentor a brand face (replacing the abstract bot icon there); the spinning bot is still used as the typing indicator.
