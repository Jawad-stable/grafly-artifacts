...
const FALLBACK_DESIGNS = [
  {
    ...
    description: "A 4:5 Instagram product post for a running sneaker launch. Bold black sans-serif headline 'AIR FLOW 24' on the left, a coral 'NEW DROP' chip, a hero product photo of the shoe with a soft cast shadow on the right, and a price tag in the bottom corner. Lots of negative space, premium athletic brand feel.",
    image_url: `${BASE}/social_sneaker.png`,
    difficulty: "intermediate",
  },
  {
    id: "social_coffee",
    title: "Coffee Brand Lifestyle Post",
    description: "A 4:5 Instagram lifestyle post for a specialty coffee brand. Top-down photo of a latte with rosetta art on a marble table, layered with a large cream serif headline 'BREW DAILY', a handwritten subtitle 'crafted in small batches', and a small wordmark 'KIN COFFEE EST. 2018' anchored at the bottom. Warm, cozy, premium.",
    image_url: `${BASE}/social_coffee.png`,
    difficulty: "beginner",
  },
  {
    id: "social_quote",
    title: "Editorial Quote Post",
    description: "A 4:5 Instagram quote post on a deep ink-blue gradient. Bold cream serif type reading 'STAY CURIOUS.' centered as the focal headline, a thin gold divider beneath, and a tracked uppercase attribution 'JANE GOODALL' below. Minimal logo mark in the bottom right. Pure typography, no photo.",
    image_url: `${BASE}/social_quote.png`,
    difficulty: "beginner",
  },
  {
    id: "social_travel",
    title: "Travel Guide Cover Post",
    description: "A 4:5 Instagram travel post for a Lisbon weekend guide. A vibrant photo of pastel Lisbon buildings with the iconic yellow tram framed inside an arched window, surrounded by a terracotta block. Bold curved sans-serif headline 'LISBON' wraps the top, a 'WEEKEND GUIDE' label sits below, and a sun-yellow '12 SPOTS' badge anchors the side.",
    image_url: `${BASE}/social_travel.png`,
    difficulty: "advanced",
  },
  { id: "ig-004", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-004.jpg`, difficulty: "beginner" },
  { id: "ig-006", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-006.jpg`, difficulty: "intermediate" },
  { id: "ig-011", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-011.webp`, difficulty: "beginner" },
  { id: "ig-046", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-046.webp`, difficulty: "advanced" },
  { id: "ig-049", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-049.jpg`, difficulty: "intermediate" },
  { id: "ig-050", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-050.jpg`, difficulty: "intermediate" },
  { id: "ig-054", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-054.jpg`, difficulty: "advanced" },
  { id: "ig-056", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-056.jpg`, difficulty: "beginner" },
  { id: "ig-057", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-057.jpg`, difficulty: "beginner" },
  { id: "ig-058", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-058.jpg`, difficulty: "intermediate" },
  { id: "ig-063", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-063.jpg`, difficulty: "beginner" },
  { id: "ig-083", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-083.jpg`, difficulty: "advanced" },
  { id: "ig-087", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-087.webp`, difficulty: "intermediate" },
  { id: "ig-103", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-103.jpg`, difficulty: "intermediate" },
  { id: "ig-109", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-109.jpg`, difficulty: "advanced" },
  { id: "ig-112", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-112.jpg`, difficulty: "beginner" },
  { id: "ig-117", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-117.jpg`, difficulty: "beginner" },
  { id: "ig-118", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-118.jpg`, difficulty: "intermediate" },
  { id: "ig-123", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-123.jpg`, difficulty: "beginner" },
  { id: "ig-126", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-126.jpg`, difficulty: "advanced" },
  { id: "ig-127", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-127.jpg`, difficulty: "intermediate" },
  { id: "ig-133", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-133.jpg`, difficulty: "intermediate" },
  { id: "ig-139", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-139.webp`, difficulty: "advanced" },
  { id: "ig-147", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-147.jpg`, difficulty: "beginner" },
  { id: "ig-148", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-148.jpg`, difficulty: "beginner" },
  { id: "ig-160", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-160.jpg`, difficulty: "intermediate" },
  { id: "ig-164", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-164.jpg`, difficulty: "beginner" },
  { id: "ig-174", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-174.jpg`, difficulty: "advanced" },
  { id: "ig-192", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-192.jpg`, difficulty: "intermediate" },
  { id: "ig-194", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-194.jpg`, difficulty: "intermediate" },
  { id: "ig-196", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-196.jpg`, difficulty: "advanced" },
  { id: "ig-197", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-197.jpg`, difficulty: "beginner" },
  { id: "ig-198", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-198.jpg`, difficulty: "beginner" },
  { id: "ig-200", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-200.jpg`, difficulty: "intermediate" },
  { id: "ig-204", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-204.jpg`, difficulty: "beginner" },
  { id: "ig-218", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-218.jpg`, difficulty: "advanced" },
  { id: "ig-227", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-227.jpg`, difficulty: "intermediate" },
  { id: "ig-240", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-240.jpg`, difficulty: "intermediate" },
  { id: "ig-251", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-251.jpg`, difficulty: "advanced" },
  { id: "ig-253", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-253.webp`, difficulty: "beginner" },
  { id: "ig-306", title: "Brand Identity Post", description: "An Instagram post built around a brand's visual identity — logo, color system, and type working as a coherent unit.", image_url: `${BASE}/instagram-306.jpg`, difficulty: "beginner" },
  { id: "ig-307", title: "Product Showcase", description: "A product-hero social post where the photograph and graphic layer compete (or collaborate) to sell a single item.", image_url: `${BASE}/instagram-307.jpg`, difficulty: "intermediate" },
  { id: "ig-326", title: "Lifestyle Content", description: "A lifestyle-driven Instagram post mixing photography with graphic elements to evoke a mood or aspiration.", image_url: `${BASE}/instagram-326.jpg`, difficulty: "beginner" },
  { id: "ig-332", title: "Editorial Composition", description: "An editorial-style social post where type, image, and white space are arranged with magazine-level precision.", image_url: `${BASE}/instagram-332.jpg`, difficulty: "advanced" },
  { id: "ig-354", title: "Promotional Campaign", description: "A promotional social media design with a clear offer, deadline, or call-to-action driving the hierarchy.", image_url: `${BASE}/instagram-354.webp`, difficulty: "intermediate" },
  { id: "ig-374", title: "Typography-Led Design", description: "A post where type does most of the heavy lifting — layout, weight, and spacing carry the entire message.", image_url: `${BASE}/instagram-374.jpg`, difficulty: "intermediate" },
  { id: "ig-416", title: "Bold Graphic Layout", description: "A high-contrast graphic composition using strong shapes, limited palette, and raw visual tension.", image_url: `${BASE}/instagram-416.jpg`, difficulty: "advanced" },
  { id: "ig-512", title: "Minimalist Social Post", description: "A restrained, clean composition that uses negative space and a tight element set as deliberate design choices.", image_url: `${BASE}/instagram-512.jpg`, difficulty: "beginner" },
];
